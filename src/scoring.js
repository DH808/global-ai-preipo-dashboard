...
function normalizeCompany(c) {
  return {
    ...
    mandateFit: c.mandateFit || '',
    whyNow: c.whyNow || '',
    keyMetrics: Array.isArray(c.keyMetrics) ? c.keyMetrics : [],
    valuationView: c.valuationView || '',
    routeToAccess: c.routeToAccess || '',
    evidenceBoundary: c.evidenceBoundary || '',
    todayDelta: c.todayDelta || '',
